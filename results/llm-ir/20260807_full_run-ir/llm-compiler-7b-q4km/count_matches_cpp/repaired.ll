You are an LLVM IR optimization assistant. Return only the requested LLVM IR module.
...
for.body.i:                                       ; preds = %for.body, %for.body.i
  ...
  %1 = load i32, ptr %add.ptr.i.i, align 4, !tbaa !5
  ...
  br i1 %or.cond.i, label %_ZL8containsSt4spanIKiLm18446744073709551615EEi.exit.loopexit, label %for.body.i, !llvm.loop !9
