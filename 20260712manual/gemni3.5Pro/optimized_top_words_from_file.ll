...
for.body122:                                      ; preds = %if.end117, %for.inc126
  ...
  %raw_c_str.2 = load ptr, ptr %add.ptr.i298, align 8, !tbaa !13
  br label %if.end.i300

if.then.i307:                                     ; preds = %invoke.cont.alloc
...
if.end.i.i305:                                    ; preds = %for.body.i
  ...
  %call.i.i306 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %raw_c_str.2, ptr noundef nonnull dereferenceable(1) %99) #28
...
for.cond.cleanup14.i:                             ; preds = %for.body15.i, %if.then7.i
  %alloc.c.str.2 = invoke noundef ptr @_Z16copy_to_c_stringRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(40) %add.ptr.i298)
          to label %invoke.cont.alloc unwind label %lpad124.loopexit

invoke.cont.alloc:                                ; preds = %for.cond.cleanup14.i
  %cmp.i299.2 = icmp eq ptr %alloc.c.str.2, null
  br i1 %cmp.i299.2, label %if.then.i307, label %if.end.alloc.2

if.end.alloc.2:                                   ; preds = %invoke.cont.alloc
  %arrayidx22.i = getelementptr inbounds nuw %struct.WordCount, ptr %call114, i64 %insert_pos.0.i
  store ptr %alloc.c.str.2, ptr %arrayidx22.i, align 8, !tbaa !20
...
for.inc126:                                       ; preds = %if.else.i304, %if.end.alloc.2
...
lpad124.loopexit:                                 ; preds = %for.cond.cleanup14.i
...
if.end5:                                          ; preds = %if.end
  ...
  br i1 %cmp.i.I encountered an error doing what you asked. Could you try again?
